...
> 当前版本：1.0.4 · 支持 macOS 14 及以上 · Universal（Apple Silicon 与 Intel）
...
默认输出为 `dist/FanTune-1.0.4-Universal.dmg`。
...
> Current version: 1.0.4 · Requires macOS 14 or later · Universal (Apple Silicon and Intel)
...
The default output is `dist/FanTune-1.0.4-Universal.dmg`.
